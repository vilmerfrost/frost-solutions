...
function LoginContent() {
 ...
 return (
  <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
   <div className="w-full max-w-md bg-gray-50 dark:bg-gray-900 rounded-3xl shadow-2xl border border-gray-100 dark:border-gray-700 p-10">
    <div className="flex flex-col items-center mb-8">
     <FrostLogo size={64} />
     <h1 className="font-semibold text-4xl mt-4 mb-2 text-gray-900 dark:text-white">
      Frost Solutions
     </h1>
    ...
    <form onSubmit={handleSubmit} className="w-full">
     ...
     <input 
      ...
      type="email" 
      required 
      className="w-full px-4 py-3 rounded-[8px] border-2 border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent mb-4" 
      placeholder="din@epost.se"
     />
     <button
      type="submit"
      disabled={loading}
      className="w-full bg-primary-500 hover:bg-primary-600 text-white rounded-[8px] py-4 font-bold text-lg shadow-md hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
     >
