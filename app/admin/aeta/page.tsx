...
import AetaClient from './AetaClient'

// SECURITY: Server-side auth check before rendering admin page
export default async function AdminAetaPage() {
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-red-50 dark:bg-red-900/20 rounded-[8px] p-6 border border-red-200 dark:border-red-800">
              ...
              <p className="text-red-700 dark:text-red-300">
                Endast administratörer kan hantera ÄTA-förfrågningar.
              </p>
            </div>
          </div>
        </main>
  ...
  return <AetaClient tenantId={adminAuth.tenantId} />
}
