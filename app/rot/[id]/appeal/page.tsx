  ...
  <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col lg:flex-row">
   ...
   <main className="flex-1 w-full lg:ml-0 overflow-x-hidden">
    <div className="p-4 sm:p-6 lg:p-10 max-w-3xl mx-auto w-full">
     ...
     {application && (
      <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 rounded-[8px] border border-red-200 dark:border-red-800">
     ...
     >
      <div>
       ...
       <textarea
        ...
        rows={6}
        className="w-full px-4 py-3 rounded-[8px] border-2 border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all hover:border-gray-300 dark:hover:border-gray-600 resize-none"
        required
       />
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4">
       <button
        type="submit"
        disabled={loading}
        className="w-full sm:flex-1 bg-error-500 hover:bg-error-600 text-white rounded-[8px] py-3 sm:py-4 font-bold text-base sm:text-lg shadow-md hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
       >
        {loading ? (
       ...
       <button
        type="button"
        onClick={() => router.back()}
        className="w-full sm:w-auto px-6 py-3 sm:py-4 rounded-[8px] border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-semibold hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-sm sm:text-base"
       >
        Avbryt
       </button>
      </div>
