...
export function VismaConnectButton({ provider }: VismaConnectButtonProps) {
 ...
 return (
  <button
   ...
   className="inline-flex items-center justify-center gap-2 px-6 py-3 min-h-[44px] text-base font-medium text-gray-900 bg-primary-500 hover:bg-primary-600 hover: rounded-lg shadow-md transition-all duration-300 ease-in-out disabled:opacity-70 disabled:cursor-not-allowed"
  >
