...
export function WeeklySchedules() {
 ...
 if (isLoading) {
  return (
   <div className="bg-gray-50 dark:bg-gray-800 rounded-[8px] sm:rounded-[8px] shadow-sm p-6 sm:p-8 border border-gray-200 dark:border-gray-700">
 ...
 return (
  <div className="bg-gray-50 dark:bg-gray-800 rounded-[8px] sm:rounded-[8px] shadow-sm p-6 sm:p-8 border border-gray-200 dark:border-gray-700 mb-6 sm:mb-8">
   <div>
