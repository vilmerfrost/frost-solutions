...
export function NewProjectModal({ isOpen, onClose, onSuccess }: NewProjectModalProps) {
  ...
  return (
    <Dialog
      ...
      maxWidth="3xl"
      title={
        <div className="text-2xl font-black bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent flex items-center gap-3">
      ...
      footer={
        <div className="flex gap-3 w-full">
          ...
          <Button
            type="submit"
            disabled={loading}
            className="flex-1 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white"
            onClick={(e) => {
              e.preventDefault()
    ...
    >
      <div className="max-w-3xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Budget Preview */}
          {budgetHours > 0 && (
            <div className="bg-gradient-to-r from-blue-50 via-purple-50 to-pink-50 dark:from-blue-900/20 dark:via-purple-900/20 dark:to-pink-900/20 border-2 border-purple-200 dark:border-purple-700 rounded-xl p-4">
