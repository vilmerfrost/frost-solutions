...
export function ProjectEmployeeManager({ projectId }: ProjectEmployeeManagerProps) {
  ...
  if (loading) {
    return (
      <div className="bg-gradient-to-br from-white via-purple-50 to-white dark:from-gray-800 dark:via-gray-800/50 dark:to-gray-800 rounded-xl shadow-xl border-2 border-purple-200 dark:border-purple-700 p-6">
      ...
      {assignedEmployees.length > 0 ? (
        <div className="space-y-3 mb-6">
          {assignedEmployees.map((assignment) => (
            <div
              key={assignment.id}
              className="flex items-center justify-between p-4 bg-white dark:bg-gray-700 rounded-lg border border-purple-100 dark:border-purple-800 hover:border-purple-300 dark:hover:border-purple-600 transition-colors"
            >
      ...
      {unassignedEmployees.length > 0 ? (
        <div className="flex gap-3">
          <select
            ...
            className="flex-1 px-4 py-2 rounded-lg border-2 border-purple-200 dark:border-purple-700 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
          >
          ...
          <button
            ...
            className="px-6 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-lg font-semibold transition-all transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center gap-2"
          >
            {assigning ? (
              <>
