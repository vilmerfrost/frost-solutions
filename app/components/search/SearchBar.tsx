      ...
      <div className="relative w-full max-w-2xl mx-auto">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-24 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400"
            disabled
            readOnly
          />
        </div>
    ...
    <div className="relative w-full max-w-2xl mx-auto">
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder="Sök projekt, kunder, fakturor..."
          className="w-full pl-12 pr-24 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
        />
        {query && (
          <button
            onClick={() => setQuery('')}
