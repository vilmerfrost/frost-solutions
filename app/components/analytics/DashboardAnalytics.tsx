...
function KPICard({
 ...
 const colorClasses = {
  ...
  purple: 'bg-purple-50 dark:bg-purple-900/20 text-primary-500 dark:text-primary-400',
 ...
 return (
  <div className="bg-gray-50 dark:bg-gray-900 rounded-[8px] shadow-md p-6 border border-gray-200 dark:border-gray-700 transition-all hover:shadow-xl">
