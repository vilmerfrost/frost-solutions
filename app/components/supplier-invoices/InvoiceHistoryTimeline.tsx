...
const eventColors: Record<string, string> = {
  ...
  ocr_scanned: 'bg-purple-100 text-purple-600 dark:bg-purple-900/30 dark:text-purple-400',
        ...
        {sortedHistory.map((event) => {
          ...
          return (
            <div key={event.id} className="relative pl-16">
              {/* Icon */}
              <div
                className={`absolute left-0 w-12 h-12 rounded-full ${colorClass} flex items-center justify-center shadow-lg`}
              >
                <Icon size={20} />
              </div>

              {/* Content */}
              <div className="bg-gradient-to-br from-white via-gray-50 to-white dark:from-gray-800 dark:via-gray-800/50 dark:to-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-4">
