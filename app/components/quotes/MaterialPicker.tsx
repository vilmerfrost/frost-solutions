...
export function MaterialPicker({ onSelect, onClose }: MaterialPickerProps) {
  ...
  return (
    <div className="space-y-4 bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-blue-900/20 dark:via-gray-800 dark:to-indigo-900/20 rounded-xl border-2 border-blue-200 dark:border-blue-700 p-6 shadow-lg">
      ...
      {materials && materials.length > 0 && (
        <div className="max-h-96 overflow-y-auto border-2 border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 shadow-inner">
          {materials.map((material) => (
            <div
              key={material.id}
              className="flex items-center justify-between p-4 hover:bg-gradient-to-r hover:from-emerald-50 hover:to-teal-50 dark:hover:from-emerald-900/20 dark:hover:to-teal-900/20 border-b border-gray-200 dark:border-gray-700 last:border-b-0 transition-colors cursor-pointer"
