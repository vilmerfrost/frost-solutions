      ...
      {quote && items && items.length > 0 && (
        <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
          <div className="flex flex-col items-end space-y-2 bg-gradient-to-r from-gray-50 to-transparent dark:from-gray-700/50 dark:to-transparent p-4 rounded-lg">
            ...
            <div className="flex justify-between w-64 text-lg font-bold border-t border-gray-300 dark:border-gray-600 pt-2 mt-2 bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">
              <span>Total:</span>
