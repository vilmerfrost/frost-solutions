...
export function QuoteList({ filters, onPageChange }: QuoteListProps) {
  ...
  if (isLoading) {
    return (
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 backdrop-blur-sm bg-opacity-95">
  ...
  if (error) {
    return (
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-red-200 dark:border-red-800 p-8 backdrop-blur-sm bg-opacity-95">
  ...
  if (quotes.length === 0) {
    return (
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 p-8 text-center backdrop-blur-sm bg-opacity-95">
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden backdrop-blur-sm bg-opacity-95">
      <Table>
        <TableHeader>
        ...
        <TableBody>
          {quotes.map((quote) => (
            <TableRow key={quote.id} className="hover:bg-gradient-to-r hover:from-gray-50 hover:to-transparent dark:hover:from-gray-700 dark:hover:to-transparent transition-all duration-200">
              <TableCell>
                ...
                <div className="relative inline-block">
                  ...
                  {menuOpen === quote.id && (
                    <>
                      ...
                      />
                      <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-xl z-20 border border-gray-200 dark:border-gray-700 backdrop-blur-sm">
                        <Link 
