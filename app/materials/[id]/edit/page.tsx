...
export default function EditMaterialPage() {
 ...
 // Load existing material data into form state
 useEffect(() => {
  if (material) {
   setSku(material.sku || '')
   setName(material.name || '')
   setCategory((material.category || material.category_type || '') as CategoryType | '')
   setUnit((material.unit || 'st') as UnitType)
   setPackageQuantity(material.package_quantity ? String(material.package_quantity) : '')
   setPurchasePrice(material.purchase_price != null ? String(material.purchase_price) : '')
   setSalePrice(material.sale_price != null ? String(material.sale_price) : (material.price != null ? String(material.price) : ''))
   setStockQuantity(material.stock_quantity != null ? String(material.stock_quantity) : '')
   setMinStockLevel(material.min_stock_level != null ? String(material.min_stock_level) : '')
   setSupplierId(material.supplier_id || '')
   setSupplierArticleNumber(material.supplier_article_number || '')
   setSupplierUrl(material.supplier_url || '')
   setIsEcoCertified(material.is_eco_certified || false)
   setIsRecyclable(material.is_recyclable || false)
   setIsHazardous(material.is_hazardous || false)
