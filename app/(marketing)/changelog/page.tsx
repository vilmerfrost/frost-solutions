      ...
      <div className="section-container">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
            Vad vi <span className="text-accent">bygger</span>
          </h1>
        ...
        <div className="flex justify-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-500/10 border border-green-500/20 text-green-600">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-foreground mb-6 flex items-center gap-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-green-500/10 text-green-600">
          ...
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-foreground mb-6 flex items-center gap-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-yellow-500/10 text-yellow-600">
