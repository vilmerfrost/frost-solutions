      ...
      <div className="section-container">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
            Insikter för <span className="text-accent">byggbranschen</span>
          </h1>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {blogPosts.map((post) => (
            ...
            >
              <div className="aspect-video bg-gradient-to-br from-accent/10 to-primary/10 flex items-center justify-center text-6xl">
                {post.image}
              </div>
              <div className="p-6">
        ...
        {/* Newsletter */}
        <div className="mt-16 rounded-2xl border border-border bg-gradient-to-br from-accent/5 to-primary/5 p-8 md:p-12 text-center">
