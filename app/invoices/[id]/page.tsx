   ...
   <main className="flex-1 lg:ml-0 overflow-x-hidden">
    <div className="p-6 lg:p-10 max-w-5xl mx-auto">
     ...
     {searchParams?.get('sent') === '1' && (
      <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-[8px] text-green-700">
     ...
     <div className="bg-white dark:bg-gray-800 rounded-[8px] shadow-md border border-gray-100 dark:border-gray-700 overflow-hidden">
         ...
         <div className="w-full max-w-md space-y-2">
          ...
          {total > 0 && (
           <>
            ...
            <div className="pt-4 border-t-2 border-gray-300 flex justify-between text-xl font-semibold text-gray-900">
      ...
      <div className="p-8 bg-gray-50 border-t border-gray-200 flex flex-wrap gap-4">
       ...
       <button
        ...
        className="bg-success-500 hover:bg-success-600 text-white px-6 py-3 rounded-[8px] font-semibold shadow-md hover:shadow-xl transition-all disabled:opacity-50"
       ...
       {isAdmin && invoice?.project_id && invoice.status !== 'paid' && (
        <button
         ...
         disabled={false}
         className="px-6 py-3 bg-green-500 hover:bg-green-600 text-white rounded-[8px] font-semibold shadow-md hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
     ...
     {/* Files Section */}
     <div className="bg-gray-50 dark:bg-gray-900 rounded-[8px] sm:rounded-[8px] shadow-md p-4 sm:p-6 lg:p-8 border border-gray-100 dark:border-gray-700 mt-6 sm:mt-8">
