...
export function AIRotSummaryButton({
  ...
  return (
    <div className="space-y-4">
      ...
      {summary && (
        <div className="p-6 bg-gradient-to-br from-white via-green-50 to-white dark:from-gray-800 dark:via-gray-800/50 dark:to-gray-800 rounded-xl shadow-xl border-2 border-green-200 dark:border-green-700">
